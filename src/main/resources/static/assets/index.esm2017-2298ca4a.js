import{l as L,p as _e,q as ge,s as me,u as Re,x as we,C as be,y as z,S as Te,z as ye,A as ke}from"./index-78594f6e.js";/**
 * @license
 ...
 */const Z="firebasestorage.googleapis.com",J="storageBucket",Ee=2*60*1e3,Ae=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var l;(function(e){e.UNKNOWN="unknown",e.OBJECT_NOT_FOUND="object-not-found",e.BUCKET_NOT_FOUND="bucket-not-found",e.PROJECT_NOT_FOUND="project-not-found",e.QUOTA_EXCEEDED="quota-exceeded",e.UNAUTHENTICATED="unauthenticated",e.UNAUTHORIZED="unauthorized",e.UNAUTHORIZED_APP="unauthorized-app",e.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",e.INVALID_CHECKSUM="invalid-checksum",e.CANCELED="canceled",e.INVALID_EVENT_NAME="invalid-event-name",e.INVALID_URL="invalid-url",e.INVALID_DEFAULT_BUCKET="invalid-default-bucket",e.NO_DEFAULT_BUCKET="no-default-bucket",e.CANNOT_SLICE_BLOB="cannot-slice-blob",e.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",e.NO_DOWNLOAD_URL="no-download-url",e.INVALID_ARGUMENT="invalid-argument",e.INVALID_ARGUMENT_COUNT="invalid-argument-count",e.APP_DELETED="app-deleted",e.INVALID_ROOT_OPERATION="invalid-root-operation",e.INVALID_FORMAT="invalid-format",e.INTERNAL_ERROR="internal-error",e.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(l||(l={}));function B(e){return"storage/"+e}function H(){const e="An unknown error occurred, please check the error payload for server response.";return new h(l.UNKNOWN,e)}function Ue(e){return new h(l.OBJECT_NOT_FOUND,"Object '"+e+"' does not exist.")}function Oe(e){return new h(l.QUOTA_EXCEEDED,"Quota for bucket '"+e+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function Ne(){const e="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new h(l.UNAUTHENTICATED,e)}function Ie(){return new h(l.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function Pe(e){return new h(l.UNAUTHORIZED,"User does not have permission to access '"+e+"'.")}function Ce(){return new h(l.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function De(){return new h(l.CANCELED,"User canceled the upload/download.")}function xe(e){return new h(l.INVALID_URL,"Invalid URL '"+e+"'.")}function Le(e){return new h(l.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+e+"'.")}function ve(){return new h(l.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+J+"' property when initializing the app?")}function Se(){return new h(l.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function Be(){return new h(l.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function Fe(e){return new h(l.UNSUPPORTED_ENVIRONMENT,`${e} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function M(e){return new h(l.INVALID_ARGUMENT,e)}function Q(){return new h(l.APP_DELETED,"The Firebase app was deleted.")}function Me(e){return new h(l.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function P(e,t){return new h(l.INVALID_FORMAT,"String does not match format '"+e+"': "+t)}function I(e){throw new h(l.INTERNAL_ERROR,"Internal error: "+e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $e(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function u(){return a===2}let c=!1;function g(...f){c||(c=!0,t.apply(null,f))}function R(f){r=setTimeout(()=>{r=null,e(w,u())},f)}function m(){o&&clearTimeout(o)}function w(f,...N){if(c){m();return}if(f){m(),g.call(null,f,...N);return}if(u()||i){m(),g.call(null,f,...N);return}s<64&&(s*=2);let T;a===1?(a=2,T=0):T=(s+Math.random())*1e3,R(T)}let b=!1;function O(f){b||(b=!0,m(),!c&&(r!==null?(f||(a=2),clearTimeout(r),R(0)):f||(a=1)))}return R(0),o=setTimeout(()=>{i=!0,O(!0)},n),O}function je(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qe(e){return e!==void 0}function Ve(e){return typeof e=="object"&&!Array.isArray(e)}function $(e){return typeof e=="string"||e instanceof String}function W(e){return j()&&e instanceof Blob}function j(){return typeof Blob<"u"&&!ke()}function X(e,t,n,s){if(s<t)throw M(`Invalid value for '${e}'. Expected ${t} or greater.`);if(s>n)throw M(`Invalid value for '${e}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ce(e){if(!e)throw H()}function _t(e,t){function n(s,r){const o=ae(e,r,t);return ce(o!==null),o}return n}function gt(e,t){function n(s,r){const o=ae(e,r,t);return ce(o!==null),ft(o,r,e.host,e._protocol)}return n}function le(e){function t(n,s){let r;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?r=Ie():r=Ne():n.getStatus()===402?r=Oe(e.bucket):n.getStatus()===403?r=Pe(e.path):r=s,r.status=n.getStatus(),r.serverResponse=s.serverResponse,r}return t}function mt(e){const t=le(e);function n(s,r){let o=t(s,r);return s.getStatus()===404&&(o=Ue(e.path)),o.serverResponse=r.serverResponse,o}return n}function Rt(e,t,n){const s=t.fullServerUrl(),r=q(s,e.host,e._protocol),o="GET",i=e.maxOperationRetryTime,a=new ue(r,o,gt(e,n),i);return a.errorHandler=mt(t),a}function wt(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}function bt(e,t,n){const s=Object.assign({},n);return s.fullPath=e.path,s.size=t.size(),s.contentType||(s.contentType=wt(null,t)),s}function Tt(e,t,n,s,r){const o=t.bucketOnlyServerUrl(),i={"X-Goog-Upload-Protocol":"multipart"};function a(){let T="";for(let p=0;p<2;p++)T=T+Math.random().toString().slice(2);return T}const u=a();i["Content-Type"]="multipart/related; boundary="+u;const c=bt(t,s,r),g=pt(c,n),R="--"+u+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(t,n){this._service=t,n instanceof _?this._location=n:this._location=_.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new U(t,n)}get root(){const t=new _(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return oe(this._location.path)}get storage(){return this._service}get parent(){const t=at(this._location.path);if(t===null)return null;const n=new _(this._location.bucket,t);return new U(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw Me(t)}}function Et(e,t,n){e._throwIfRoot("uploadBytes");const s=Tt(e.storage,e._location,ie(),new k(t,!0),n);return e.storage.makeRequestWithTokens(s,he).then(r=>({metadata:r,ref:e}))}function At(e){e._throwIfRoot("getDownloadURL");const t=Rt(e.storage,e._location,ie());return e.storage.makeRequestWithTokens(t,he).then(n=>{if(n===null)throw Be();return n})}function Ut(e,t){const n=ut(e._location.path,t),s=new _(e._location.bucket,n);return new U(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe="storage";function vt(e,t,n){return e=L(e),Et(e,t,n)}function St(e){return e=L(e),At(e)}function Bt(e,t){return e=L(e),It(e,t)}function Ft(e=me(),t){e=L(e);const s=_e(e,fe).getImmediate({identifier:t}),r=ge("storage");return r&&Ct(s,...r),s}function Ct(e,t,n,s={}){Pt(e,t,n,s)}function Dt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new V(n,s,r,t,Te)}function xt(){we(new be(fe,Dt,"PUBLIC").setMultipleInstances(!0)),z(G,Y,""),z(G,Y,"esm2017")}xt();export{St as a,Ft as g,Bt as r,vt as u};
